...
public:
    ...
    /// <summary>
    /// QUIC_STATUS를 EQuicError로 변환합니다.
    /// </summary>
    static EQuicError ConvertQuicStatus(QUIC_STATUS Status);
    ...
    /// <summary>
    /// TLS Provider로 OpenSSL을 사용하는지 여부를 반환합니다.
    /// </summary>
    /// <returns></returns>
    static bool UseOpenSSL();
...
private:
    ...
    static void OpenRegistration(QUIC_EXECUTION_PROFILE ExecutionProfile = QUIC_EXECUTION_PROFILE_LOW_LATENCY);
